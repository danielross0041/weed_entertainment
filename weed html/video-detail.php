                            ...
                            <div class="row">
                                <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12 col-xxl-12">
                                    <div class="video-player">
                                        <video class="video-control" muted controls>
                                            <source src="images/HomepageHeroReel.mp4" type="video/mp4">
                                        </video>
                                    </div>
                                </div>
                                <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12 col-xxl-12">
                                    <div class="y-tube-video-name">
                                        <h6 class="title">Permanent Marker - by Doja - Strain Review - April 2022</h6>
                                        <ul class="share-ul">
                                        ...
                                        <div class="row align-items-center">
                                            <div class="col-12 col-sm-12 col-md-6 col-lg-6 col-xl-6 col-xxl-6">
                                                <div class="y-tube-flex">
                                                    <div class="img">
                                                        <img src="images/unnamed.jpg" class="img-fluid thumb" alt="">
                                                    </div>
                                ...
                                <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12 col-xxl-12">
                                    ...
                                    <div class="comment">
                                        <ul class="comm-ul">
                                            <li class="li">
                                                <img src="images/thumbnail.jpg" class="comment-thumb" alt="">
                                            </li>
                                            <li class="li">
                                                <form action="">
                                    ...
                                    <div class="pstd-comment">
                                        <ul class="pstd-ul">
                                            <li class="li">
                                                <img src="images/thumbnail.jpg" class="img" alt="">

                                                <div class="comm-desc">
                                                    <div class="name">
                                                        <span class="user-n">Jane Smith</span>
                                                        <span class="date-time">6 months ago</span>
                                                    </div>
                                                    <p class="para">He doesn't have those absurd flicks and b hops, but
                                                        his
                                                        aim is
                                                        so fluid, natural and satisfying to watch. It's amazing how he
                                                        doesn't lose
                                                        his calm and aways patiently gets his crosshair on them heads.
                                                    </p>
                                                </div>
                                            </li>
                                        </ul>
                                        ...
                                        <div class="reply-main">
                                            <span class="like-main">
                                                ...
                                                <div class="comment user_reply">
                                                    <ul class="comm-ul">
                                                        <li class="li">
                                                            <img src="images/thumbnail.jpg" class="comment-thumb"
                                                                alt="">
                                                        </li>
                                                        <li class="li">
                                                            <form action="">
                                        ...
                                        <div class="reply-all">
                                            <a href="javascript:;" class="reply-all-anchor">2 reply</a>
                                                ...
                                                <ul class="pstd-ul">
                                                    <li class="li">
                                                        ...
                                                        <div class="comm-desc">
                                                            ...
                                                            <p class="para">He doesn't have those absurd flicks and b
                                                                hops, but
                                                                his
                                                                aim is
                                                                so fluid, natural and satisfying to watch. It's amazing
                                                                how he
                                                                doesn't lose
                                                                his calm and aways patiently gets his crosshair on them
                                                                heads.
                                                            </p>
                                                        </div>
                                                    </li>
                                    ...
                                    <!-- comment posted by others close -->
