...
$role_assign = App\Models\role_assign::where('is_active' ,1)->where("role_id" ,$user->role_id)->orderBy('id','desc')->first();
            ...
            <div class="site-width">
                ...
                <ul id="side-menu" class="sidebar-menu">
                    <li class="dropdown active"><a href="#"><i class="icon-home mr-1"></i> Dashboard</a>                  
                        <ul>
                            <li class="{{ Request::path()=='dashboard'? 'active': '' }}"><a href="{{route('dashboard')}}"><i class="icon-rocket"></i> Dashboard</a></li>
                            {{--
                            ...
                            @if($sidebar_data)
                                @foreach($sidebar_data as $side)
                                    {{--
                                    <li class="{{ Request::path()=='attribute/'.str_replace('-', ' ',$side)? 'active': '' }}"><a href="{{route('listing',$side)}}" data-actor="{{$side}}"><i class="{{Helper::get_sidebar_icon($side)}}"></i> {{ucwords(str_replace('-', ' ',$side))}}</a></li>
                                    --}}
                                    <li class="{{ Request::path()=='attribute/'.$side? 'active': '' }}"><a href="{{route('listing',$side)}}" data-actor="{{$side}}"><i class="{{Helper::get_sidebar_icon($side)}}"></i> {{ucwords(str_replace('-', ' ',$side))}}</a></li>
                                @endforeach
                            @endif
                    ...
                    <li class="dropdown"><a href="#"><i class="icon-layers mr-1"></i> Web Apps</a>                  
                        <ul>
                            ...
                            <li class="dropdown {{ Request::path()=='web-config'||Request::path()=='logo'? 'active': '' }}"><a href="#"><i class="icon-options"></i>Website Settings</a>
                                <ul class="sub-menu">
                                    <li class="{{ Request::path()=='web-config'? 'active': '' }}"><a href="{{route('web_config')}}"><i class="icon-energy"></i> Config</a></li>
                                    <li class="{{ Request::path()=='logo'? 'active': '' }}"><a href="{{route('logo')}}"><i class="icon-energy"></i> Logo</a></li>
                                </ul>
                            </li> 
                        ...
                        <ul>
                            <li class="dropdown"><a href="#"><i class="icon-options"></i>Reports</a>
                                <ul class="sub-menu">
                                    ...
                                    <li>
                                        <a href="{{route('all_registered_user_report',['basic'])}}"><i class="icon-energy"></i> All User - Basic Info</a>
                                    </li>
                                    <li>
                                        <a href="{{route('all_registered_user_report',['personnel'])}}"><i class="icon-energy"></i> All User - Personnel Info</a>
                                    </li>
                                    
                                    <li>
                                        <a href="{{route('registered_user_report')}}"><i class="icon-people"></i> Manage User</a>
                                    </li>
                                    <li>
                                    ...
                                    @if($sidebar_data)
                                        @foreach($sidebar_data as $side)
                                            <li><a href="{{route('report_user',$side)}}" data-actor="{{$side}}"><i class="fa fa-eye"></i> {{ucwords($side)}}</a></li>
                                        @endforeach
                                    @endif
                                    
                                    <li><a href="{{route('all_leave_application_report')}}"><i class="icon-disc"></i> Leave Application</a></li>
                                    
                                    <li><a href="{{route('birthday_list')}}"><i class="icon-present"></i> Upcoming B-Day</a></li>
